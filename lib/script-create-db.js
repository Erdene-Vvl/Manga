...
await schema.dropTableIfExists("manga");
await schema.dropTableIfExists("banner");
await schema.dropTableIfExists("creator");
await schema.dropTableIfExists("creator_manga");
await schema.dropTableIfExists("episode");
await schema.dropTableIfExists("image");
await schema.dropTableIfExists("rating");
await schema.dropTableIfExists("comment");
await schema.dropTableIfExists("liked");
